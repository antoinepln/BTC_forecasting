...
Table des matières
Introduction  1
Analysis of bitcoin price movements 3
Features explorations 5
Preprocessing & Training Architecture 7
preprocessing 7
logarithmic transformation  7
Scaling 7
TRAINNING ARCHITECTURE  8
Neural Networks 9
DNN 9
LSTM  12
Result  14
...
MVRV_Z  0.13077
 NVTS 0.13077
Pct_profit  0.03021
Supp_last_act 0.34538
Transact_sec  0.89880
Hash_rate 0.94882
Transactions_count  0.89880
Utxo_spent  0.91461
Fees_total  0.59172
Sp    0.00969
...
Moreover when we vary the periods we find interesting results for mvrv_z, nvts, and pct_profit, for example period (2016-03-09 - 2017-07-22) :
...
['new_adress', 'sopr', 'utxo', 'transac_sec', 'mvrv_z', 'nvts', 'pct_profit', 'active_adress', 'hash_rate', 'transactions_count','utxo_spent']
...
As mentioned above, the evolution of prices is punctuated by major upward cycles. This implies much higher local highs, and orders of magnitude clearly different according to the periods, even relatively close. We thus perform a logarithmic transformation for our indicators, which are not bounded. Our multiplicative series becomes additive.  This transformation does not replace the scaling that will be done later. It does not serve as a denoising that we will try to add to our models later.
 ...
 On the left, historical bitcoin prices before logarithmic transformation, on the right the same prices after logarithmic transformation..
